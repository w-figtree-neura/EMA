...
<Library LVVersion="16008000">
	...
	<Item Name="Fick to Rotation Matrix.vi" Type="VI" URL="../Fick to Rotation Matrix.vi"/>
	<Item Name="Multiply Matrix.vi" Type="VI" URL="../Multiply Matrix.vi"/>
	<Item Name="Rotation Matrix to Fick.vi" Type="VI" URL="../Rotation Matrix to Fick.vi"/>
</Library>
